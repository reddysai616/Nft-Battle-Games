...
import { Alert  ,PlayerInfo ,Card ,GameInfo, ActionButton } from '../components'
...
const Battle = () => {
  ...
  useEffect(() =>{
    const getPlayerInfo = async () =>{
      try {
        ...
        console.log(setPlayer1 , 'Player1')
        console.log(setPlayer2 , 'Player2')
  ...
  return (
    <div className={`${styles.flexBetween} ${styles.gameContainer} ${battleGround}`}>
      ...
      <h2 className='text-xl'>{battleName}</h2>
